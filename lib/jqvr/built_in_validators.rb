module Jqvr
  ...
  module BuiltInValidators
    ...
    MappedValidators.add :inclusion, "inclusion:%{options[:in]}" 
    ...
    MappedValidators.add :numericality, "numericalityGreterThen:%{options[:greater_then]}"
    ...
    MappedValidators.add :numericality, "numericalityLessThen:%{options[:less_than]}"
